<div class="list-group">
    ...
    <div class="">
        ...
        <div class="collapse" id="collapseExample">
            <div class="card-body">
                <a href="inv_query.php
                " class="list-group-item list-group-item-action">庫存查詢</a>
                <a href="inv_maintain.php
                "  class="list-group-item list-group-item-action">庫存維護</a>
                <a href="pn_query.php" class="list-group-item list-group-item-action">品號維護</a>
